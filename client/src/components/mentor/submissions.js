...
export default function Submissions() {
	...
	const uniqUsers = [ ...allQuestionsAndAnswers.reduce((map, obj) => map.set(obj.student_number, obj), new Map()).values()];
                    ...
                    <div className="pitchCard" key={index}>
                        ...
                        <div>
                            <div>
                                ...
                                <Link to={`/dashboard/mentor/submission/review-pitch`} className="yellowButton">
                                   Review Pitch
                                </Link>
                            </div>
                        </div>
