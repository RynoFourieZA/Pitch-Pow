...
import logo from "../assets/images/business-man_grey.png";
...
const SideMenu = (props) => {
    ...
    useEffect(() => {
      ...
      //just an improvement and it is not recorded in video :(
    ...
    return (
        ...
        <div className="top-section">
          <div className="logo">
                    <img src={logo} alt="business-man_grey"/>
                    </div>
